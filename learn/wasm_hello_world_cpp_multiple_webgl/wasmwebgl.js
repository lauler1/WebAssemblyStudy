...
//const requestAnimationFrame = document2.requestAnimationFrame;

var animationFrameIdx = 0;
function requestAnimationFrame(tick){
	animationFrameIdx++;
	if(animationFrameIdx%2){
		document1.makeCurrent();
		return document1.requestAnimationFrame(tick, 0);
	}else{
		document2.makeCurrent();
		return document2.requestAnimationFrame(tick, 0);
	}
}
